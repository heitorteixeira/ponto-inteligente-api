...
import com.heitor.pontointeligente.api.dtos.CadastroPessoaJuridicaDTO;
...
public class CadastroPessoaJuridicaController {
     ...
     * @param result
     */
    private void validarDadosExistentes(CadastroPessoaJuridicaDTO cadastroPJDto, BindingResult result) {
     ...
     * @return Empresa
     */
    private Empresa converterDtoParaEmpresa(CadastroPessoaJuridicaDTO cadastroPJDto) {
     ...
     * @throws NoSuchAlgorithmException
     */
    private Funcionario converterDtoParaFuncionario(CadastroPessoaJuridicaDTO cadastroPJDto, BindingResult result)
            throws NoSuchAlgorithmException {
     ...
     */
    private CadastroPessoaJuridicaDTO converterCadastroPJDto(Funcionario funcionario) {
